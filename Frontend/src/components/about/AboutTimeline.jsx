...
const AboutTimeline = () => {
    const milestones = [
        {
            ...
            description: "Virtue Hire was born from a vision to revolutionize the recruitment industry with transparency.",
        ...
        },
        {
            ...
            description: "Launched our first AI matching algorithm with 50+ early-adopter partner companies.",
            icon: <Zap size={24} />,
            color: "var(--secondary)"
        },
        {
            year: "2024",
            title: "Global Reach",
            description: "Expanded services to 10+ countries and reached 50,000+ successful placements.",
            icon: <Globe size={24} />,
            color: "var(--accent)"
        },
        {
            ...
            description: "Launched our full-featured mobile app for on-the-go recruitment management.",
        ...
        },
        {
            ...
            description: "Introduced advanced compliance and multi-tenant features for Fortune 500 clients.",
            icon: <Rocket size={24} />,
            color: "#10b981"
        },
        {
            ...
            description: "Awarded 'Best Recruitment Tech' at the Global HR Excellence Awards.",
            icon: <Trophy size={24} />,
            color: "#f59e0b"
        }
    ]
    ...
    return (
        <section style={{ padding: '100px 0', background: 'var(--white)' }} id="about-timeline">
            <div className="container">
                ...
                <div style={{ position: 'relative', maxWidth: '900px', margin: '0 auto' }}>
                    ...
                    <div style={{ 
                        ...
                        width: '4px', height: '100%', background: 'var(--medium-gray)', 
                    ...
                    {milestones.map((milestone, index) => {
                        ...
                        return (
                            <div key={index} style={{ 
                                ...
                                marginBottom: '4rem', position: 'relative', width: '100%' 
                            }}>
                                {/* Timeline Dot */}
                                <div style={{ 
                                    position: 'absolute', left: '50%', transform: 'translateX(-50%)', 
                                    width: '24px', height: '24px', background: 'white', 
                                    border: `4px solid ${milestone.color}`, borderRadius: '50%', 
                                    zIndex: 2, top: '24px' 
                                }} />
                                ...
                                >
                                    <div style={{ 
                                        fontSize: '0.9rem', fontWeight: '800', color: milestone.color, 
                                        marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '1px' 
                                    }}>
                                        {milestone.year}
                                    </div>
                                    <h3 style={{ fontSize: '1.4rem', fontWeight: '800', color: 'var(--dark)', marginBottom: '1rem' }}>
                                        {milestone.title}
                                    </h3>
