...
import { ShieldCheck, Lightbulb, Heart, Users, Rocket, HelpCircle } from 'lucide-react';
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
                    {values.map((value, index) => (
                        ...
                        >
                            ...
                            <h3 style={{ fontSize: '1.4rem', fontWeight: '800', color: 'var(--dark)', marginBottom: '1rem' }}>{value.title}</h3>
