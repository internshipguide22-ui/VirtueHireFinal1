...
function PaymentFailed() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#f8fafc", padding: "20px" }}>
      ...
      >
        <h2 style={{ margin: "0 0 12px", color: "#b91c1c" }}>Subscription Activation Failed</h2>
        <p style={{ margin: "0 0 20px", color: "#475569", lineHeight: 1.6 }}>
          We could not activate the selected HR subscription. Please try again from the plans screen.
        </p>
        <button
          type="button"
