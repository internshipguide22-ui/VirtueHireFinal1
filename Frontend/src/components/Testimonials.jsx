...
const Testimonials = () => {
    const baseTestimonials = [
        ...
        {
            rating: 5,
            content: "The automated interview scheduling alone saved me a week of administrative work this month. This tool is a lifesaver.",
            author: "AK",
            name: "Anna Kendrick",
    ...
    return (
        <section id="testimonials" style={{ padding: '100px 0', background: 'var(--light-gray)', overflow: 'hidden' }}>
            <div className="container">
                ...
                >
                    ...
                    <p style={{ fontSize: '1.2rem', color: 'var(--text-gray)' }}>
                        Hear directly from the candidates and companies accelerating their growth.
                    </p>
                </motion.div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: '15vw', background: 'linear-gradient(to right, var(--light-gray), transparent)', zIndex: 10, pointerEvents: 'none' }} />
                <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: '15vw', background: 'linear-gradient(to left, var(--light-gray), transparent)', zIndex: 10, pointerEvents: 'none' }} />
                ...
                >
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            <div style={{ position: 'absolute', top: '2rem', right: '2rem', color: testimonial.color, opacity: 0.1 }}>
                                <Quote size={80} />
                            </div>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                ...
                                <div>
                                    <h4 style={{ color: 'var(--dark)', fontWeight: '800', fontSize: '1rem', marginBottom: '2px' }}>{testimonial.name}</h4>
                                    <p style={{ color: 'var(--text-gray)', fontSize: '0.85rem', fontWeight: '600' }}>{testimonial.position}</p>
                                </div>
                            </div>
                        </div>
                    ))}
