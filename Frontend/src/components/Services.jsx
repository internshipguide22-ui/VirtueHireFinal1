...
import { Building2, FileCheck, LineChart, Users, ArrowRight } from 'lucide-react';
    ...
    const services = [
        {
            ...
            description: "End-to-end recruitment pipelines designed for startups to Fortune 500s. We seamlessly integrate with your existing HR flow.",
        ...
        },
        {
            ...
            description: "Lifecycle tracking from the first application to their complete automated onboarding process.",
            ...
            <div className="container">
                ...
                >
                    ...
                    <p style={{ fontSize: '1.15rem', color: 'var(--text-gray)' }}>
                        Designed to meet the needs of all stakeholders in the recruitment process, making hiring effortless.
                    </p>
                </motion.div>
                ...
                >
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div style={{ flex: 1 }}>
                                <h3 style={{ fontSize: '1.6rem', fontWeight: '800', color: 'var(--dark)', marginBottom: '1rem', letterSpacing: '-0.5px' }}>
                                    {service.title}
                                </h3>
                                <p style={{ color: 'var(--text-gray)', marginBottom: '1.5rem', lineHeight: '1.6', fontSize: '1.05rem', maxWidth: '90%' }}>
                                    {service.description}
                                </p>
                            </div>
